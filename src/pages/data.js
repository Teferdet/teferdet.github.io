export const poems = [
    {title:"Тепла осінь", published:"9.11.2023", poem:"На дворі листопад фарбує листя,<br>" +
    ...
    {title:"Гріхи", published:"21.08.2023", poem:"Потойбічний світ цікавий, чи не так? <br>" +
    ...
    {title:"Ми всі помремо", published:"05.01.2024", poem:"Ми помремо заливаючися кров'ю, <br>" +
    ...
    {title:"Про твою смерть", published:"21.12.2023", poem:"Рано чи пізно вона настигне тебе.<br>" +
    ...
    {title:"Лікуюча зима", published:"21.11.2023", poem:"Снігом покрила все навколо <br>" +
    ...
    {title:"Польоти у мріях ", published:"19.12.2023", poem:"Перед сном завжди вони є,<br>" +
            ...
            "А ми почекаємо,<br>" +
            "Нікуди нам спішити."},
    {title:"Старі спогади", published:"01.06.2024", poem:"Лиш сум залишився з того часу,<br>" +
    ...
    {title:"Сни", published:"21.08.2023", poem:"Очі поступово злипаються,<br>" +
            ...
            "А її до мене…"},
    {title:"Моя мова", published:"04.07.2024", poem:"Я пишу ці рядки <br>" +
